...
::: callout-caution
Aquí va una visualización de la frontera de producción
:::
...
- [Puntos inalcanzables.]{.unerline} Aquellos puntos que se encuentra por encima de la curva son posiciones inalcanzables con los factores productivos y la tecnología disponible en ese momento dado. En nuestra aldea no podemos pescar 30 peces y recolectar 40 vegetales (punto G). Esa combinación es inalcanzable con los recursos y tecnología que tenemos. Sin embargo, con el paso del tiempo, las posiciones inalcanzables se pueden llegar a alcanzar si suceden una serie de circunstancias. Es lo que llamamos crecimiento económico.

::: callout-caution
Aquí va una visualización de la frontera de producción con puntos ineficientes e inalcanzables.
:::
...
![](assets/cap1-edificios-gomez.png)
