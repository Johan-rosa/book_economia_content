...
\hypersetup{
  pdftitle={Introducción a la Economía},
...
\title{Introducción a la Economía}
...
\pandocbounded{\includegraphics[keepaspectratio]{assets/adam-smith.png}}\end{minipage}%
%
\begin{minipage}{0.50\linewidth}
\pandocbounded{\includegraphics[keepaspectratio]{assets/alfred-marshal.png}}\end{minipage}%
\newline
\begin{minipage}{0.50\linewidth}
\pandocbounded{\includegraphics[keepaspectratio]{assets/lionel-robbins.png}}\end{minipage}%
%
\begin{minipage}{0.50\linewidth}
\pandocbounded{\includegraphics[keepaspectratio]{assets/gary-becker.png}}\end{minipage}%
\newline
\begin{minipage}{0.50\linewidth}
\pandocbounded{\includegraphics[keepaspectratio]{assets/paul-samuelson.png}}\end{minipage}%
%
\begin{minipage}{0.50\linewidth}
\pandocbounded{\includegraphics[keepaspectratio]{assets/joseph-stiglitz.png}}\end{minipage}%

\end{figure*}%

\begin{tcolorbox}[enhanced jigsaw, breakable, toprule=.15mm, leftrule=.75mm, colback=white, opacityback=0, bottomrule=.15mm, rightrule=.15mm, colframe=quarto-callout-note-color-frame, arc=.35mm, left=2mm]
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{assets/cap1-fpp-platano-cafe.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{assets/cap1-fpp-categorias.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{assets/cap1-edificios-gomez.png}}
